        ...
        VStack(alignment: .center) {
            ...
            VStack {
                ZStack {
                    ...
                    Circle()
                        .trim(from: 0.0, to: CGFloat(vm.current_quiz!.currentQuestion) / CGFloat(vm.current_quiz!.questions.count))
                    ...
                    Text("\(vm.current_quiz!.currentQuestion)/\(vm.current_quiz!.questions.count)" as String)
                ...
                VStack {
                    Text("You answered \(vm.current_quiz!.history.count) out of \(vm.current_quiz!.questions.count)" as String)
